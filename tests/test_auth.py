...
from src.auth.validator import (
...
@pytest.mark.parametrize(
    ...
    [
        ("abc", "La clave debe tener entre 6 y 10 caracteres."),
        ("abcdef", "La clave debe incluir al menos una mayuscula."),
        ("ABCDEF", "La clave debe incluir al menos una minuscula."),
        ("Abcdef", "La clave debe incluir al menos un numero."),
        ("Abcdef1", "La clave debe incluir al menos un caracter especial"),
        ("Aaaaa1=", "La clave no puede tener mas de 3 caracteres iguales seguidos."),
    ],
)
