...
def test_impact_record_fields():
    record = make_impact_record(
        impact_id="IMP-001",
        interaction_point="calculator_screen",
        before_behavior="No calculation result shown",
        after_behavior="Calculation result displayed with path id",
        validation_reference="test_gui_trigger_success",
    )
