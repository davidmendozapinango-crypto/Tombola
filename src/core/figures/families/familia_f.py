"""Familia F: tablero de ajedrez (idéntica a la Familia E).

Descripción:
    Reusa la misma lógica de patrón alternante que la Familia E. Mantener
    como módulo separado facilita cambios experimentales en el futuro.
"""
...
def _mask_main(n: int) -> "np.ndarray":
    """Máscara de tablero (paridad de índices)."""
    _validate_n(n)
